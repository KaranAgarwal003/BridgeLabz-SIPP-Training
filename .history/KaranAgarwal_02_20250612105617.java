...
public class KaranAgarwal_02 {
    ...
    public static void main(String[] args) {
        ...
        int fees=125000;
        int discount=10;
        double discounted amount=fees*discount/100;
        double finalFees = fees - discounted amount;
        System.out.println("The discount amount is INR "+discounted and final discounted fee is INR ___);
    }
}
